...
public class Client extends Thread { 
	...
	/* Implement the code for the run method */
        	...
        	if(this.clientOperation.equalsIgnoreCase("sending")) {
        		sendClientStartTime=System.currentTimeMillis();        		
        		//send the transaction array to network in buffer which implements thread yield
        		//send transactions method deals with the array       		
        	...
        	if(this.clientOperation.equalsIgnoreCase("receiving")) {
        		//receive the updated info from network out buffer which implements thread yield
